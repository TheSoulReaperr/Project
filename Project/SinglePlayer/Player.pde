...
void initPlayer() {
  ...
  playerY = height/3;
  switch(plane) {
    case 1 : planeImg = plane1; playerW = 130*m; playerH = 60*m; playerSpeed = 7*m;  break;  
    case 2 : planeImg = plane2; playerW = 150*m; playerH = 60*m; playerSpeed = 9*m;  break;
    case 3 : planeImg = plane3; playerW = 150*m; playerH = 60*m; playerSpeed = 13*m; break;
